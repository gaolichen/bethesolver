...
// the macro hash_value in lrcalc conflicts with the one in boost.
#undef hash_value
#define hash_value_s(itr) ((itr).s->elts[(itr).i].value)

// the hash_next of lrcalc lib cannot compile. So use this one to replace it.
#define hash_next_s(itr) \
